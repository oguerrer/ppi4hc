...
IF0 = df_base.values[:,-1]

df_temp = pd.read_csv(home+'/data/sims/IFF.csv')
IFF = df_temp.values[0]

df_temp = pd.read_csv(home+'/data/sims/IFY.csv')
IFY = df_temp.values[0]

df_temp = pd.read_csv(home+'/data/sims/IFR.csv')
IFR = df_temp.values[0]
...
counter_Is = {}
dfs = pd.read_csv(home+'/data/sims/sensitivity.csv')
IFI = dfs.values[:,-1]
